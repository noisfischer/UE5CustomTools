...
# Get Blueprint class
blueprint = unreal.EditorAssetLibrary.load_asset('/Game/Blueprints/Grappling/BP_GrappleTarget')
blueprint_class = unreal.load_class(None, blueprint.get_path_name())

#Spawn the actor
new_grapple_target_actor = unreal.EditorLevelLibrary.spawn_actor_from_object(blueprint, spawnLocation)

# Output the name of the spawned actor (Optional)
print(f'Spawned actor with name: {new_grapple_target_actor.get_name()}')
