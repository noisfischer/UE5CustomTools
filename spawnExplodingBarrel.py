...
#Specifies distance from camera at which to spawn the exploding barrel
distance = 500
...
# Get Blueprint class
blueprint = unreal.EditorAssetLibrary.load_asset('/Game/Blueprints/ExplodingBarrel/BP_ExplosiveBarrel')
